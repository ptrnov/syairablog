...
class AppAssetResume extends AssetBundle
{
    ...
    public $css = [        
       ...
       'https://fonts.googleapis.com/css?family=Saira+Extra+Condensed:100,200,300,400,500,600,700,800,900',
        'https://fonts.googleapis.com/css?family=Open+Sans+Condensed:300,300i,400,400i,600,600i,700,700i,800,800i',
        ...
        'template/devicon/devicon.min.css',
        'template/devicon/devicon-colors.css',
    ];
    public $js = [
